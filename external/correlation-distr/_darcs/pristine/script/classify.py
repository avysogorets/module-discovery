...
#from maxEntNips import MaxEntNips
#from maxEntNewsgroups import MaxEntNewsgroups
#from naiveBayesNewsgroups import NaiveBayesNewsgroups
#from cosineClassifier import CosineClassifier
...
if __name__ == "__main__":
    ...
    parseopts.add_option("-n", "--newsgroups", dest="newsgroups", default=
                         "/u/melsner/research/correlation/20ng/groups.dump",
                         type="string",
