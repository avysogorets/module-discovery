...
def output_builder(
    ...
    if mixing_in_layer == 'angle':
        ...
        if mode == 'relative':
            ...
            result = cos_tensor
    if len(attribution_tensor.shape) == 5:
        attribution_tensor = attribution_tensor.sum(1)
...
class BertLayer(nn.Module):
    ...
    def forward(
        ...
        if decompx_ready:
            ...
            if not decompx_config.include_res2:
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if self.decompx_config:
                ...
                if self.decompx_config.aggregation_in_encoder == "rollout":
                    if aggregated_encoder_norms is None: # first layer
