...
#if (defined(ILO_HP11) && defined(ILO64)) || (defined(ILO_LINUX) && defined(ILO64)) || (defined(ILO_AMD64)) || (defined(ILO_APPLE))
class IloVarArgsNum {
	IloNum _value;
public:
...
inline int IloSPrintf( char *dest, size_t size, const char* format, ... ) {

       va_list ptr;
       va_start( ptr, format );

       return vsnprintf( dest, size, format, ptr );
}
