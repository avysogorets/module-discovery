...
public class FacilityExplanations {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            IloIntVar[] supplier = cp.intVarArray(
                nbStores, 0, nbLocations - 1, "S"
            );
            IloIntVar[] open = cp.intVarArray(nbLocations, 0, 1, "O");
            ...
            cp.setParameter(
                IloCP.IntParam.SearchType, IloCP.ParameterValues.DepthFirst
            );
            cp.setParameter(IloCP.IntParam.LogPeriod, 1);
            cp.setParameter(
                IloCP.IntParam.LogSearchTags, IloCP.ParameterValues.On
            );
