...
public class SearchPhases {
    public static void main(String[] args) {
        ...
        try {
            ...
            IloSearchPhase sp2 = cp.searchPhase(
                x,
            ...
            IloSearchPhase sp3 = cp.searchPhase(
                x,
    ...
    public static void printIntVars(IloCP cp, IloIntVar[] x, String name) throws IloException {
        System.out.print("[");
