...
// Exportable data needs to be tuples
{definitionType} GasolinesData = ...;
{definitionType} OilsData = ...;

{string} Gasolines = {g.name | g in GasolinesData };
{string} Oils = {o.name | o in OilsData };
...
tuple parametersType {
	float MaxProduction;
	float ProdCost;
}
parametersType Parameters = ...;

float MaxProduction = Parameters.MaxProduction;
float ProdCost = Parameters.ProdCost;
