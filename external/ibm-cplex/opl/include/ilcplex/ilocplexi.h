...
public:
  ...
  enum IntParam {
    ...
    CardLS CPXDEPRECATEDENUMVAL(22010100) = CPX_PARAM_CARDLS
  };
...
#define CPX_MIPSEARCH_DYNAMIC            2
  ...
  public:
    ...
    class Context {
      ...
      {}
    public:
      void getIndices(IloNumVarArray vars, IloIntArray& idx) const;
      struct Info {
        enum Infos {
...
#         include "iloCPXCALLBACKSOLUTIONSTRATEGYenum.h"
      ...
      void getCandidatePoint(IloIntArray const &vars, IloNumArray &vals) const;
      ...
      void getRelaxationPoint(IloIntArray const &varIdx, IloNumArray &vals) const;
      ...
      void getIncumbent(IloIntArray const &vars, IloNumArray &vals) const;
      ...
      void getLocalLB(IloIntArray const &vars, IloNumArray &vals) const;
      ...
      void getLocalUB(IloIntArray const &vars, IloNumArray &vals) const;
      ...
      void getGlobalLB(IloIntArray const &vars, IloNumArray &vals) const;
      ...
      void getGlobalUB(IloIntArray const &vars, IloNumArray &vals) const;
