...
public:
  ...
  IloIntGeneratorI* within(IloIntCollectionExprI* expr) const;
...
public:
  ...
  IloNumGeneratorI* within(IloNumCollectionExprI* expr) const;
...
public:
  ...
  IloSymbolGeneratorI* within(IloSymbolCollectionExprI* expr) const;
  virtual void visitSubExtractables(IloExtractableVisitor* v) ILO_OVERRIDE;
  virtual IloBool hasNongroundType() const ILO_OVERRIDE;
