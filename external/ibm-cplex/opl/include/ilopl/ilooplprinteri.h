...
class IloInferredCollectedMapI;
class IloInferredExprArrayI;
...
class IloSubCircuitCollectedMapI;
...
public:
    ...
    void printIloInferredCollectedMapI(const IloInferredCollectedMapI* e);
    void printIloInferredExprArrayI(const IloInferredExprArrayI* e);
    ...
    void printIloSubCircuitCollectedMapI(const IloSubCircuitCollectedMapI* e);
