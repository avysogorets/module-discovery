...
public class SchedCalendar {
    ...
    static final int[] taskDurations = { 35, 15, 40, 15, 5, 10, 5, 10, 5, 5, };
    ...
    static IloIntervalVar[] itvFromList(List<IloIntervalVar> list) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            cp.add(cp.noOverlap(itvFromList(joeTasks)));
            cp.add(cp.noOverlap(itvFromList(jimTasks)));
