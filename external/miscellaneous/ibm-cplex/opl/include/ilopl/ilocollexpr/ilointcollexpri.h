...
class IloIntCollectionIndexI : public IloIntCollectionExprI {
  ILOEXTRDECL
public:
...
public:
  ...
  IloIntCollectionExprGeneratorI(IloEnvI* env, IloIntIndexI* x, IloIntCollectionExprI* expr);
...
class IloIntRangeExprI : public IloIntCollectionExprI {
  ILOEXTRDECL
  IloIntExprI* _lb;
  IloIntExprI* _ub;
  virtual void visitSubExtractables(IloExtractableVisitor* v) ILO_OVERRIDE;
...
class IloIntAggregateSetExprI : public IloIntCollectionExprI {
  ILOEXTRDECL
...
class IloIntAggregateUnionSetExprI : public IloIntCollectionExprI {
  ILOEXTRDECL
  IloExtendedComprehensionI* _comp;
  virtual void visitSubExtractables(IloExtractableVisitor* v) ILO_OVERRIDE;
public:
...
class IloIntAggregateInterSetExprI : public IloIntCollectionExprI {
  ILOEXTRDECL
  IloExtendedComprehensionI* _comp;
  virtual void visitSubExtractables(IloExtractableVisitor* v) ILO_OVERRIDE;
public:
