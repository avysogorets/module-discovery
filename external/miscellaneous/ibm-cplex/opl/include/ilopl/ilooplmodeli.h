...
public:
	...
	virtual IloInt getStateValue( const IloStateFunctionExprArg stateFct, const IloModelEvaluatorSolutionGetterBaseI::FunctionField field, const IloInt pos = -1 ) const ILO_OVERRIDE {
